...
pub struct SharedRuntimeArgs {
    ...
    #[arg(
        long,
        value_parser = parse_json::<CorsArgList>,
        value_name = "JSON"
    )]
    #[serde(default)]
    allowed_origins: Option<CorsArgList>,
    ...
    #[serde(default)]
    allowed_methods: Option<CorsArgList>,
    ...
    #[serde(default)]
    allowed_headers: Option<CorsArgList>,
    ...
    fn cors_config(&self) -> CorsConfig {
        CorsConfig {
            ...
            allowed_origins: self
                .allowed_origins
                .clone()
                .map(CorsArgList::into_vec)
                .unwrap_or_else(default_cors_wildcard),
